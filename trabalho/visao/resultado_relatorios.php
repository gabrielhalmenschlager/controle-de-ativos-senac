...
<div class="container mt-5">
    ...
    <div class="container mt-5">
        <div class="d-flex flex-column align-items-center">
            <h1 class="mb-4 text-center" style="color: #003B5C;">Relatório Gerado
                <a href="relatorio.php" class="btn ml-3 d-inline-block" style="background-color: #6c757d; color: white;">Voltar</a>
            </h1>
            ...
            <table class="table table-striped table-bordered table-hover" id="tabela-personalizada">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #003B5C; color: white;" scope="col">Tipo Mov</th>
                        <th style="background-color: #003B5C; color: white;" scope="col">Quantidade Uso</th>
                        <th style="background-color: #003B5C; color: white;" scope="col">Quantidade Mov</th>
