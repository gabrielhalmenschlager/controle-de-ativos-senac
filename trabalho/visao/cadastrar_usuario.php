        ...
        <div class="form-container">
            ...
            <form action="../controle/cadastrar_usuario_controle.php" method="POST">
                ...
                <div class="form-group mb-4">
                    <label for="senha" class="form-label" style="color: #003B5C;">Senha</label>
                    <input type="password" class="form-control shadow-sm border-light" name="senha" id="senha" placeholder="Crie uma senha" required>
                </div>

                <button type="submit" class="btn btn-primary w-100" style="background-color: #003B5C; border-color: #003B5C;">Salvar</button>
            </form>
        </div>
    </div>
